define({ "api": [
      ...
      "fields": {
        "200": [
          ...
          },
          {
            ...
            "type": "Array[]",
            "optional": false,
            "field": "data.array.event.stripe",
            "description": "<p>Array Event stripe data</p>"
          },
          {
            "group": "200",
            "type": "Numeric",
            "optional": false,
            "field": "data.array.event.stripe.id",
            "description": "<p>Id stripe data</p>"
          },
          {
            "group": "200",
            "type": "Numeric",
            "optional": false,
            "field": "data.array.event.stripe.event_id",
            "description": "<p>Event id of stripe data</p>"
          },
          {
            "group": "200",
            "type": "Numeric",
            "optional": false,
            "field": "data.array.event.stripe.event_money_id",
            "description": "<p>Event money id of stripe data</p>"
          },
          {
            "group": "200",
            "type": "String",
            "optional": false,
            "field": "data.array.event.stripe.stripe_account_id",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "data.array.event.stripe.email",
            "description": "<p>Stripe account email</p>"
          },
          {
            "group": "200",
            "type": "Array[]",
            "optional": false,
            "field": "data.array.event.stripe.event_payment",
            "description": "<p>Array Event stripe data payment</p>"
          },
          {
            "group": "200",
            "type": "Array[]",
            "optional": false,
            "field": "data.array.event.stripe.event_payment.array",
            "description": "<p>Array stripe data payment</p>"
          },
          {
            "group": "200",
            "type": "Number",
            "optional": false,
            "field": "data.array.event.stripe.event_payment.array.id",
          ...
          },
          {
            ...
            "type": "Number",
            "optional": false,
            "field": "data.array.event.stripe.event_payment.array.strip_event_many_data_connect_id",
            "description": "<p>Payment stripe event money data connect id</p>"
          },
          {
            "group": "200",
            "type": "Number",
            "optional": false,
            "field": "data.array.event.stripe.event_payment.array.amount",
            "description": "<p>Payment amount (in cents)</p>"
          },
          {
            "group": "200",
            "type": "Number",
            "optional": false,
            "field": "data.array.event.stripe.event_payment.array.amount_result",
            "description": "<p>Payment amount result(in cents)</p>"
          },
          {
            "group": "200",
            "type": "String",
            "optional": false,
            "field": "data.array.event.stripe.event_payment.array.stripe_charge_id",
            "description": "<p>Payment stripe charge id</p>"
          },
          {
            "group": "200",
            "type": "Number",
            "optional": false,
            "field": "data.array.event.stripe.event_payment.array.profit",
            "description": "<p>Site profit(in cents)</p>"
          },
          {
            "group": "200",
            "type": "Number",
            "optional": false,
            "field": "data.array.event.stripe.event_payment.array.stripe_profit",
            "description": "<p>Stripe profit(in cents)</p>"
          },
          {
            "group": "200",
            "type": "String",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "description": "<p>Sum of needed many (in dollars). Required</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
      ...
      "fields": {
        "200": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "stripe.stripe_account_id",
            "description": "<p>Stripe account id</p>"
          },
          {
            "group": "200",
          ...
          },
          {
            ...
            "type": "Array[]",
            "optional": false,
            "field": "stripe.event_payment.array",
            "description": "<p>Array stripe data payment</p>"
          },
          {
            "group": "200",
            "type": "Number",
            "optional": false,
            "field": "stripe.event_payment.array.id",
            "description": "<p>Payment id</p>"
          },
          {
            "group": "200",
            "type": "Number",
            "optional": false,
            "field": "stripe.event_payment.array.strip_event_many_data_connect_id",
            "description": "<p>Payment stripe event money data connect id</p>"
          },
          {
            "group": "200",
            "type": "Number",
            "optional": false,
            "field": "stripe.event_payment.array.amount",
            "description": "<p>Payment amount (in cents)</p>"
          },
          {
            "group": "200",
            "type": "Number",
            "optional": false,
            "field": "stripe.event_payment.array.amount_result",
            "description": "<p>Payment amount result(in cents)</p>"
          },
          {
            "group": "200",
            "type": "String",
            "optional": false,
            "field": "stripe.event_payment.array.stripe_charge_id",
            "description": "<p>Payment stripe charge id</p>"
          },
          {
            "group": "200",
            "type": "Number",
            "optional": false,
            "field": "stripe.event_payment.array.profit",
            "description": "<p>Site profit(in cents)</p>"
          },
          {
            "group": "200",
            "type": "Number",
            "optional": false,
            "field": "stripe.event_payment.array.stripe_profit",
            "description": "<p>Stripe profit(in cents)</p>"
          }
        ]
      },
  ...
  {
    "type": "get",
    "url": "/api/event/:event_id/payment/account",
    "title": "Create Stripe Account for Event money",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "country_sortname",
            "description": "<p>Country sortname of payment account</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "email",
            "description": "<p>Email of payment account</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "pay_token",
            "description": "<p>Payment token of payment account</p>"
          }
        ]
      },
      "examples": [
        ...
        "500": [
          {
            ...
            "optional": false,
            "field": "mess",
            "description": "<p>Same unspecified error</p>"
          }
        ]
      },
      "examples": [
    ...
    "version": "0.0.0",
    "filename": "./app/Http/Controllers/Event/EventPaymentController.php",
    "groupTitle": "Event_Stripe"
  },
  {
    "type": "get",
    "url": "/api/event/:event_id/payment/charge",
    "title": "Create payment to event money needs",
    "name": "Create_payment",
    "group": "Event_Stripe",
    "permission": [
      {
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "amount",
            "description": "<p>Amount to be donated by the user (in dollars)</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  {
    "type": "get",
    "url": "/api/event/:event_id/payments/all",
    "title": "Get All Event Money Transfers",
    "name": "Get_All_Event_Money_Transfers",
    "group": "Event_Stripe",
    "permission": [
      {
        "name": "User",
        ...
        "200": [
          {
            ...
            "optional": false,
            "field": "array",
            "description": "<p>Data array of Money Transfers.</p>"
          },
          {
            "group": "200",
            "type": "Number",
            "optional": false,
            "field": "array.id",
            "description": "<p>Id Money Transfers.</p>"
          },
          {
            "group": "200",
            "type": "Number",
            "optional": false,
            "field": "array.strip_event_many_data_connect_id",
            "description": "<p>Stripe content id of event Money Transfers.</p>"
          },
          {
            "group": "200",
            "type": "Number",
            "optional": false,
            "field": "array.amount",
            "description": "<p>Total amount of money transfer. (in cents)</p>"
          },
          {
            "group": "200",
            "type": "Number",
            "optional": false,
            "field": "array.amount_result",
            "description": "<p>Amount of money transfer to the account of the event.(in cents)</p>"
          },
          {
            "group": "200",
            "type": "String",
            "optional": false,
            "field": "array.stripe_charge_id",
            "description": "<p>Stripe Id of Money Transfers.</p>"
          },
          {
            "group": "200",
            "type": "Number",
            "optional": false,
            "field": "array.profit",
            "description": "<p>Money arrive at the account of the site.(in cents)</p>"
          },
          {
            "group": "200",
            "type": "Number",
            "optional": false,
            "field": "array.stripe_profit",
            "description": "<p>Price of services of Stripe.(in cents)</p>"
          }
        ]
      },
      "examples": [
  ...
  {
    "type": "get",
    "url": "/api/admin/event/:event_id/payments/sum",
    "title": "Get Profit from event for admin",
    "name": "Get_Profit_from_event_for_admin",
    "group": "Event_Stripe",
    "permission": [
      {
        "name": "Admin",
        ...
        "200": [
          {
            ...
            "optional": false,
            "field": "result",
            "description": "<p>Amount of money transfer to the account of the event.(in dollars)</p>"
          }
        ]
      },
      "examples": [
    ...
    "version": "0.0.0",
    "filename": "./app/Http/Controllers/Admin/EventPaymentController.php",
    "groupTitle": "Event_Stripe"
  },
  {
    "type": "get",
    "url": "/api/admin/event/payments/sum/period",
    "title": "Get Profit from period for admin",
    "name": "Get_Profit_from_period_for_admin",
    "group": "Event_Stripe",
    "permission": [
      {
        "name": "Admin",
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "start_date",
            "description": "<p>Start Date with time in format &quot;YYYY-MM-DD HH:MM:SS&quot;. required|string</p>"
          },
          {
            "group": "Parameter",
            "type": "String/Date",
            "optional": false,
            "field": "finish_date",
            "description": "<p>Finish Date with time in format &quot;YYYY-MM-DD HH:MM:SS&quot;. required|string</p>"
          }
        ]
      },
      "examples": [
        {
          "title": "Request-Example:",
          "content": "{\n  \"start_date\": \"2018-05-21 00:00:00\"\n  \"finish_date\": \"2018-06-21 23:59:59\"\n}",
          "type": "json"
        }
      ]
    },
  ...
  {
    "type": "get",
    "url": "/api/event/:event_id/payments/sum",
    "title": "Get Sum Event Money Transfers",
    "name": "Get_Sum_Event_Money_Transfers",
    "group": "Event_Stripe",
    "permission": [
      {
        "name": "User",
  ...
  {
    "type": "get",
    "url": "/api/event/payment/public_key",
    "title": "Get public Stripe token(key)",
    "name": "Get_public_Stripe_token",
    "group": "Event_Stripe",
    "permission": [
      {
        "name": "User",
        ...
        "200": [
          {
            ...
            "optional": false,
            "field": "key",
            "description": "<p>String with public Stripe API key(token).</p>"
          }
        ]
      },
      "examples": [
